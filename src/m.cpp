...
float m::smooth_damp(
    ...
    float exp = (float) (1.0 / (1.0 + (double) x + 0.479999989271164 * (double) x * (double) x +
                                0.234999999403954 * (double) x * (double) x * (double) x));
...
glm::vec2 m::smooth_damp(
    ...
    float exp = (float) (1.0 /
                         (1.0 + (double) num2 +
                          0.479999989271164 * (double) num2 * (double) num2 +
